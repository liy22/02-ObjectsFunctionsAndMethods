...
def main():
    ...
    #better_draw_circles(rg.Point(-200,10),10)
    #better_draw_circles(rg.Point(20,10),20)
    #even_better_draw_circles(rg.Point(100,10),20,9,'pink',6)
    #even_better_draw_circles(rg.Point(12,15),6,30,'orange',2)
    better_draw_circles(rg.Point(-200, 10), 10)
    even_better_draw_circles(rg.Point(100, 10), 20, 9, 'pink', 6)
    even_better_draw_circles(rg.Point(-50, -100), 20, 9, 'pink', 6)
    even_better_draw_circles(rg.Point(-100,40),30,8,'purple',8)
    window.update()
